    ...
    return (
        <> 
            <div className="h-auto w-full justify-center items-center grid grid-cols-4 mt-12"> 
                <span className="text-6xl col-span-1 border-r-4 border-black p-10 text-right">Frontend </span>
                <div className="col-span-3 ml-5">
                    ...
                    <br></br>
                    <span className="text-2xl col-span-3  text-justify  font-semibold"> Stack:</span>
                </div>
