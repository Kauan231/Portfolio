...
export default function Projetos() {
    return (
        ...
        <div className='flex justify-center align-middle bg-stone-100  pb-12'>
                <span className='font-semibold lg:text-[3vw] text-[8vw] text-center lg:underline underline-offset-1 pb-12'>Personal Projects</span>
        </div>
        ...
        <div className='pb-12 bg-stone-100'>
            ...
            <div className="w-full h-full bg-gradient-to-b from-slate-200 to-sky-200 pb-12 pt-20">
                <div className='flex justify-center align-middle '>
                        <span className='font-semibold lg:text-[3vw] text-[8vw] text-center lg:underline underline-offset-1 pb-12'>Professional Projects</span>
                </div>
